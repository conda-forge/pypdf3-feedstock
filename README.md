...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypdf3-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13384&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypdf3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypdf3` can be installed with:

```
conda install pypdf3
```

It is possible to list all of the versions of `pypdf3` available on your platform with:
